...
const DefaultServiceConfig = `{"methodConfig":[{"name":[{}], "timeout":"10s", "retryPolicy":{"maxAttempts":5, "initialBackoff":"0.200s", "maxBackoff":"60s", "backoffMultiplier":2, "retryableStatusCodes":["UNAVAILABLE", "UNKNOWN"]}}]}`
